...
export const custom_content = {
	'wondercraft:aluminum_dust': {
		texture: 'textures/items/aluminum_dust',
		type: 'item',
	},
	'wondercraft:copper_dust': {
		texture: 'textures/items/copper_dust',
		type: 'item',
	},
	'wondercraft:gold_dust': {
		texture: 'textures/items/gold_dust',
		type: 'item',
	},
	'wondercraft:iron_dust': {
		texture: 'textures/items/iron_dust',
		type: 'item',
	},
	'wondercraft:lead_dust': {
		texture: 'textures/items/lead_dust',
		type: 'item',
	},
	'wondercraft:silver_dust': {
		texture: 'textures/items/silver_dust',
		type: 'item',
	},
	'wondercraft:tin_dust': {
		texture: 'textures/items/tin_dust',
		type: 'item',
	},
	'wondercraft:zinc_dust': {
		texture: 'textures/items/zinc_dust',
		type: 'item',
	},
};
...
export const CHEST_UI_SIZES = new Map(chestUiSizesEntries);
